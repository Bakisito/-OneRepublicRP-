...
Config.KeyDescription = "esto abrirá un vehículo de radio (puede ser rebinded)"
...
Config.defaultList = {
    ...
    {
        label = "Tomorrowland - One World Radio",
        url = "https://www.youtube.com/watch?v=araK9j8mN9Y",
    },
    {
        label = "Gangsta Rap Radio",
        url = "https://www.youtube.com/watch?v=0MOkLkTP-Jk",
    },
    {
        label = "Reggaeton Old School",
        url = "https://www.youtube.com/watch?v=uU1pWM1tyYE",
    },
    {
        label = "Bachata Radio",
        url = "https://www.youtube.com/watch?v=82-zMPjs3Uo",
    },
    {
        label = "Kiss 99.4",
        url = "https://rstream.hostdime.com/proxy/kiss949?mp=/8880",
    },
}
...
-- Message list
Config.Messages = {
    ["streamer_on"]  = "El modo Streamer está activado. A partir de ahora no oirás ninguna música/sonido.",
    ["streamer_off"] = "El modo Streamer está desactivado. A partir de ahora podrás escuchar la música que reproduzcan los jugadores.",
}
