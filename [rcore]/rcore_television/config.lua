...
Config.Messages = {
    ["streamer_on"] = "El modo Streamer está activado. A partir de ahora no escuchará música/sonido de ningún televisor",
    ["streamer_off"] = "El modo Streamer está desactivado. A partir de ahora podrá ver cualquier televisor",
}
...
Config.listVideos = {
    [1] = {
        ...
        url = "https://livestream.com/eadbcd67-8ab9-4d8f-a782-eca7c78ddca5"
    },
    [2] = {
        name = "Teleantillas",
        icon = "fas fa-cat",
        url = "https://www.dailymotion.com/video/x809r6i"
    },
    [3] = {
        name = "Video 3",
        icon = "fas fa-city",
        url = "https://tvonline.com.do/canal-7-en-vivo-antena-7-online/"
    },
    [4] = {
        name = "Video 4",
...
Config.CreateTelevisionModelOnCoords = {
    {
        ...
        Position = vector3(460.51, -984.2, 31.7),
        Heading = 180.00,
    },
}
...
Config.resolution = {
    ...
    [GetHashKey("apa_mp_h_str_avunits_04")] = {
        ItemToOpen = {"remote"},
        ScreenOffSet = vector3(-1.00938, -0.32753, 2.00415),
        ScreenSize = vector3(0.020845, 0.01213, 0.0),
        distanceToOpen = Config.DefaultOpenDistance,
        distance = Config.visibleDistance,
        CameraOffSet = {
            x = -0.1,
    ...
    [GetHashKey("hei_heist_str_avunits_01")] = {
        ItemToOpen = {"remote"},
        ScreenOffSet = vector3(-1.051695, -0.33845, 2.122015),
        ScreenSize = vector3(0.041895, 0.02396, 0.0),
        distanceToOpen = Config.DefaultOpenDistance,
        distance = Config.visibleDistance,
        CameraOffSet = {
            x = -0.1,
    ...
    [GetHashKey("apa_mp_h_str_avunitm_03")] = {
        ItemToOpen = {"remote"},
        ScreenOffSet = vector3(-1.052515, -0.290205, 2.119235),
        ScreenSize = vector3(0.047045, 0.02691, 0.0),
        distanceToOpen = Config.DefaultOpenDistance,
        distance = Config.visibleDistance,
        CameraOffSet = {
            x = -0.1,
    ...
    [GetHashKey("hei_heist_str_avunitl_01")] = {
        ItemToOpen = {"remote"},
        ScreenOffSet = vector3(-1.682065, -0.15134, 1.989865),
        ScreenSize = vector3(0.07098, 0.04051, 0.0),
        distanceToOpen = Config.DefaultOpenDistance,
        distance = Config.visibleDistance,
        CameraOffSet = {
            x = -0.1,
    ...
    [GetHashKey("vw_prop_vw_cinema_tv_01")] = {
        ...
        distanceToOpen = 10.0,
        distance = 20.0,
        ScreenOffSet = vector3(-1.56, -0.06, 0.91),
        ScreenSize = vector3(0, 0, 0),
        CameraOffSet = {
            x = 0.15,
            y = -2.7,
    ...
    [GetHashKey("apa_mp_h_str_avunitm_01")] = {
        ItemToOpen = { "remote" },
        ScreenOffSet = vector3(-1.039065, -0.34720, 2.107245),
        ScreenSize = vector3(0.046940, 0.024510, 0.0),
        rotationOffset = vector3(0, 0, 0), -- rotation of scaleform
        distanceToOpen = Config.DefaultOpenDistance,
        distance = Config.visibleDistance,
        CameraOffSet = {
            x = 0.5,
    ...
    [GetHashKey("xm_prop_x17_tv_ceiling_01")] = {
        --Job = { ["police"] = {"*"},  },
        ItemToOpen = {"remote"},

        ScreenOffSet = vector3(-0.7530, -0.6660, -0.42520),
        ScreenSize = vector3(0.042, 0.0222, 0.0),
        distanceToOpen = Config.DefaultOpenDistance,
        distance = Config.visibleDistance,
        CameraOffSet = {
            x = -0.0,
