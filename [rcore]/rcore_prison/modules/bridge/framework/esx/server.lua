        ...
        IsResourceLoaded(Prison.FrameworkTriggers['resourceName'], function(state, func)
            if state then
                ...
                AddEventHandler('playerDropped', function()
                    ...
                    if CWUsers[Source] then
                        if CWUsers[Source].currentDone > 0 then
                            CWUsers[Source].currentDone = 0
                        end
                    end
                ...
                if IsScriptLoaded('cd_spawnselect') then
                    ...
                    RegisterNetEvent('rcore_prison:requestInternalLoad', function()
                        ...
                        if data and data.state == 'jailed' then
                            ...
                            if not state then
                                LevelDebug(3, 'inform', 'Player was teleported back to prison. [%s]', player.name)
                            end
                        end
