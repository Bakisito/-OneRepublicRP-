return {
    ...
    Canteen = {
        {
            label = 'Pedazo de pizza - Jalapeño',
            cost = 100,
            itemName = 'pizzaslice'
        },
        {
    ...
    interaction = {
        ...
        },
        {
            ...
            trade = {
                ...
                {
                    label = 'Batman Rebirth Comic Book #1',
                    transaction = {
                        takeCount = 3,
                        takeItem = Prison.ECONOMY_ITEM,
                        giveItem = 'comic_book_2',
                        giveCount = 1,
                    },
                }
            },
        ...
        },
        {
            ...
            coords = vec3(1827.25, 2589.75, 46.56),
            type = 'booth',
        },
        {
            npc = nil,
            ...
            coords = vec3(1827.25, 2587.72, 46.56),
            type = 'booth',
        },
        {
            npc = nil,
