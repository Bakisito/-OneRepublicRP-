    ...
    AddEventHandler('cd_dispatch:CallCommand', function(data, data_2)
        ...
        if OnDuty > 0 then
            ...
            if data_2.anonymous then
                ...
                TriggerEvent("cd_dispatch:logtodiscord", "New Alert From: " ..data_2.char_name, " Message: " ..message, 16753920) --change the color at the end to your liking
            else
                TriggerClientEvent('cd_dispatch:AddNotification', -1, {
                    job_table = data_2.job_table,
                    coords = data.coords,
...
local DiscordWebhook = "https://discord.com/api/webhooks/1124214882561179710/q3_Nud8Mxb8qwfvhHmva-j-PeCqOLx3rqjQEpfeN1JsYxHpPDFrWdEqo-DSBdntTJDMk" -- Replace with your webhook URL

RegisterServerEvent("cd_dispatch:logtodiscord")
AddEventHandler("cd_dispatch:logtodiscord", function(title, description, color)
    ...
    PerformHttpRequest(DiscordWebhook, function(err, text, headers) end, "POST", payload, { ["Content-Type"] = "application/json" })
end)