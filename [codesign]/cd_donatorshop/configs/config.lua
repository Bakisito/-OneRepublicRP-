...
Config.Language = 'ES' --[ 'EN' / 'CZ' / 'ES' / 'FI' / 'FR' / 'NL' / 'SE' / 'SK' ] You can add your own locales to the Locales.lua. But make sure to change the Config.Language to match it.
...
Config.TebexListings = { --These are the products that you will list for sale on your tebex website.
    [1] = {
        ProductName = '100 OR Coins', --You can change this, but this ProductName must be identical to the name of the product on your tebex website.
        Amount = 100, --This is the amount of coins the player will recieve when he purchases this product (you can change this).
    },

    [2] = {
        ProductName = '250 OR Coins',
        Amount = 250,
    },

    [3] = {
        ProductName = '500 OR Coins',
        Amount = 500,
    },

    [4] = {
        ProductName = '750 OR Coins',
        Amount = 750,
    },

    [5] = {
        ProductName = '1,200 OR Coins',
        Amount = 1200,
    },
}
...
Config.Vehicles = {
    ...
    [1] = {Cost = 300, Model = 'zx10r', Name = 'Ninja® ZX-10R', Description = 'Kawasaki Ninja® ZX-10R', Coords = vector4(0, 0, 0, 0)},
    [2] = {Cost = 1000, Model = '22lp610', Name = 'Huracan LP610', Description = 'Lamborghini Huracan LP610', Coords = vector4(0, 0, 0, 0)},
    [3] = {Cost = 400, Model = '19raptor', Name = '150 Raptor', Description = 'Ford 150 RAPTOR', Coords = vector4(0, 0, 0, 0)},
    [4] = {Cost = 300, Model = 'eclipse', Name = 'Eclipse', Description = 'Mitsubishi Eclipse', Coords = vector4(0, 0, 0, 0)},
    [5] = {Cost = 250, Model = 'ap2', Name = 'S2000', Description = 'Honda S2000', Coords = vector4(0, 0, 0, 0)},
    [6] = {Cost = 500, Model = 'g65amg', Name = 'AMG G 65', Description = 'Mercedes-AMG G 65', Coords = vector4(0, 0, 0, 0)},
...
Config.Shop = {
    ...
    -- [5] = {
    --     Title = 'Gold Bars',
    --     Description = 'x5 24 carat gold bars',
    --     Input_Type = 'number',
    --     Input_Description = '1 = x5 items',
    --     MaxLength = nil,
    --     Pattern = nil,
    --     Image = 'goldbar.png',
    --     Cost = 5,
    ...
    --     Quantity = nil,
    --     ItemName = {'adder', 'seashark', 'caddy'},
    -- },

    -- [8] = { --This will only work with cd_multicharacter unless you edit the code.
