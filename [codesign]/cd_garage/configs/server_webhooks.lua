...
local ExploitLogWebhook = 'https://discord.com/api/webhooks/1122416085577240646/N29wEfjgyZe3jQLLDvSoua02MjVjbvGPG-MwI2niGEy2MqlFiaF_jbrMPRB9xV4Y0Biy' --If a player is found using cheat engine to change the hash of a vehicle, this will send a message on discord and kick them from the game.
local ImpoundLogWebhook = 'https://discord.com/api/webhooks/1122416085577240646/N29wEfjgyZe3jQLLDvSoua02MjVjbvGPG-MwI2niGEy2MqlFiaF_jbrMPRB9xV4Y0Biy' --When a player impounds/unimpounds a vehicle.
local TransferVehicleLogWebhook = 'https://discord.com/api/webhooks/1122416085577240646/N29wEfjgyZe3jQLLDvSoua02MjVjbvGPG-MwI2niGEy2MqlFiaF_jbrMPRB9xV4Y0Biy' --When a player transfers a vehicle to another player.
local VehicleManagementLogWebhook = 'https://discord.com/api/webhooks/1122416085577240646/N29wEfjgyZe3jQLLDvSoua02MjVjbvGPG-MwI2niGEy2MqlFiaF_jbrMPRB9xV4Y0Biy' --When a staff member uses the vehicle managment commands.
local GarageSpaceLogWebhook = 'https://discord.com/api/webhooks/1122416085577240646/N29wEfjgyZe3jQLLDvSoua02MjVjbvGPG-MwI2niGEy2MqlFiaF_jbrMPRB9xV4Y0Biy' --When a player sells a garage slot.
