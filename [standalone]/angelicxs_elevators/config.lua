...
Config.ElevatorWaitTime = 2.5					-- How many seconds until the player arrives at their floor

Config.Notify = {
	enabled = true,							-- Display hint notification?
	distance = 3.0,							-- Distance from elevator that the hint will show
	message = "Apunta el ascensor para utilizarlo"	-- Text of the hint notification
}
...
Config.Elevators = {
	...
	PillboxElevatorNorth = {
		{
			coords = vector3(332.37, -595.56, 43.28), heading = 70.65, level = "Piso 1", label = "Pillbox - Planta principal",
		},
		{
			coords = vector3(344.31, -586.12, 28.79), heading = 252.84, level = "Piso 0", label = "Pillbox - Piso inferior",
			-- jobs = {
			-- 	["police"] = 0,
			-- 	["ambulance"] = 0,
			-- },
		...
		{
			coords = vector3(340.05, -584.98, 28.79), heading = 88.21, level = "Piso -1", label = "Pillbox - Estacionamientos",
			-- jobs = {
			-- 	["police"] = 0,
			-- 	["ambulance"] = 0,
			-- },
	...
	PillboxElevatorSouth = {
		{
			coords = vector3(330.45, -601.07, 43.28), heading = 67.64, level = "Piso 1", label = "Pillbox - Planta principal",
		},
		{
			coords = vector3(345.68, -582.34, 28.79), heading = 248.30, level = "Piso 0", label = "Pillbox - Piso inferior",
			-- jobs = {
			-- 	["police"] = 0,
			-- 	["ambulance"] = 0,
			-- },
		...
		{
			coords = vector3(341.58, -580.88, 28.79), heading = 70.59, level = "Piso -1", label = "Pillbox - Estacionamientos",
			-- jobs = {
			-- 	["police"] = 0,
			-- 	["ambulance"] = 0,
			-- },
	...
	PillboxRoofTop = {
		{
			coords = vector3(338.52, -583.84, 74.16), heading = 254.13, level = "Piso 2", label = "Pillbox - HeliPad",
			-- jobs = {
			-- 	["police"] = 0,
			-- 	["ambulance"] = 0,
			-- },
		...
		{
			coords = vector3(327.17, -603.87, 43.28), heading = 338.36, level = "Piso 1", label = "Pillbox - Planta principal",
			-- jobs = {
			-- 	["police"] = 0,
			-- 	["ambulance"] = 0,
			-- },
