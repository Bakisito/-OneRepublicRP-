        ...
        if IsPedInMeleeCombat(myPed) then
            ...
            if (HasPedBeenDamagedByWeapon(myPed, GetHashKey("WEAPON_UNARMED"), 0) )then
                ...
                if GetEntityHealth(myPed) < 140 then
                    ...
                    if Config.QBCore == true then
                        Framework.Functions.Progressbar("random_task", "Estás noqueado", Config.progressbarDurantion, false, true, {
                        ...
                        exports['progressBars']:startUI(Config.progressbarDurantion, "Estás noqueado")
                    end
                    knockedOut = true
