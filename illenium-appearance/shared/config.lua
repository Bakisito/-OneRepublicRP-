...
Config.TargetConfig = {
    ...
    ["tattoo"] = {
        ...
        scenario = "WORLD_HUMAN_STAND_MOBILE",
        icon = "fas fa-pen",
        label = "Abrir tienda de tatuajes",
        distance = 3
    },
    ["surgeon"] = {
...
Config.Stores = {
    ...
    {
        type = "surgeon",
        coords = vector4(314.1, -565.27, 43.28, 235.83),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(315.13, -571.83, 43.28),
            vector3(311.27, -570.59, 43.28),
            vector3(314.17, -561.99, 43.28),
            vector3(317.81, -563.32, 43.28),
            }
    }
}
...
Config.ClothingRooms = {
    {
        job = "police",
        targetModel = "s_f_y_cop_01",
        coords = vector4(450.65, -997.6, 31.7, 298.52),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(450.4, -998.78, 33.87),
            vector3(454.81, -998.83, 33.4),
            vector3(454.52, -993.3, 33.54),
            vector3(450.45, -993.29, 34.23)
        }
    },
    {
        job = "police",
        targetModel = "s_f_y_cop_01",
        coords = vector4(472.33, -980.46, 23.94, 32.04),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(467.94, -980.46, 26.13),
            vector3(473.36, -980.67, 25.7),
            vector3(473.4, -977.08, 25.6),
            vector3(467.64, -977.1, 25.33)
               }
    },

    {
        job = "ambulance",
        targetModel = "s_m_m_doctor_01", -- overrides the target ped configured for the group
        coords = vector4(301.84, -599.37, 43.28, 71.54),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            ...
            vector3(302.4, -597.71, 43.28),
            vector3(299.14, -596.79, 43.28)
        }
    },

    {
        job = "mechanic1",
        targetModel = "mp_m_waremech_01", -- overrides the target ped configured for the group
        coords = vector4(153.29, -3015.16, 7.04, 6.4),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(151.82, -3015.23, 8.29),
            vector3(154.4, -3015.37, 8.25),
            vector3(154.22, -3009.97, 7.04),
            vector3(151.95, -3009.95, 7.04)
        }
    },
    {
        job = "mechanic2",
        targetModel = "s_m_y_xmech_02", -- overrides the target ped configured for the group
        coords = vector4(-1427.53, -460.05, 35.91, 36.74),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(-1428.07, -460.59, 37.24),
            vector3(-1430.21, -457.48, 38.38),
            vector3(-1427.86, -455.82, 37.67),
            vector3(-1425.81, -459.18, 37.93)
        }
    },
    {
        job = "biembo",
        ...
        usePoly = false,
        points = {
            vector3(551.72, -183.87, 56.38),
            vector3(548.46, -183.82, 55.77),
            vector3(548.44, -179.93, 55.77),
            vector3(551.88, -179.84, 56.01)
        }
    },
    {
        job = "mechanic4",
        targetModel = "mp_m_weapexp_01", -- overrides the target ped configured for the group
        coords = vector4(1189.76, 2637.73, 38.4, 94.27),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(1190.03, 2640.61, 40.12),
            vector3(1186.09, 2640.68, 40.01),
            vector3(1186.01, 2635.17, 39.96),
            vector3(1189.94, 2635.13, 40.56)
        }
    },
    {
        job = "mechanic5",
        targetModel = "mp_f_bennymech_01", -- overrides the target ped configured for the group
        coords = vector4(98.26, 6617.99, 32.44, 305.37),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
            vector3(96.56, 6619.94, 34.68),
            vector3(98.99, 6622.14, 34.73),
            vector3(103.58, 6617.9, 34.11),
            vector3(100.5, 6614.92, 34.62)
        }
    }
}
