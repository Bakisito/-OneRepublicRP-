...
Config.KeysList = {}
Config.MetadataItem = true
Config.GiveMotelKeyCommandName = "givemotelkey"
---------------------------------------------------- IMPORTANT --------------------------------------------------------------
Config.Inventory = "QBCore" -- or "QBCore" or "core" or "ox"
...
Config.ShowRoomNo = "verhabitaciones" -- Command that makes all room numbers visible from afar when near the motel.
...
Config.MotelSalePriceRatio = 10 -- The fee reimbursed when the motel owner sells the business.
