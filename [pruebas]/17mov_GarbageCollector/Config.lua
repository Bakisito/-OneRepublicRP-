...
Config.JobCooldown = 15 * 60 -- 10 * 60            -- 0 minutes cooldown between making jobs (in brackets there's example for 10 minutes)
...
Config.Lang = {
    ...
    ["too_far"] = "Tu partida ha empezado a trabajar, pero estas my lejos de la sede. Todavia te les puedes unir.",
    ["kicked"] = "Has expulsado %s de tu partida",
    ["alreadyWorking"] = "Primero, completa la orden previa",
    ["quit"] = "Has abandonado el Equipo",
    ["pickGarbage"] = "Recoge la basura",
    ["putGarbage"] = "Tira la basura dentro",
    ["cantSpawnVeh"] = "El sitio para spawnear el camion esta ocupado.",
    ["full"] = "El camion de basura ya esta full!",
    ["wrongCar"] = "Este no es tu camion de basura",
    ["CarNeeded"] = "Necesitas tu camion de basura para finalizar el trabajo.",
    ...
    ["notFullJob"] = "Necesitas hacer un progreso del 100% antes de terminar el trabajo",
    ...
    ["tutorial"] = "Este trabajo se basa en recolectar basura por la ciudad. Puedes recoger cualquier bolsa de basura que este en el suelo. Despues de recoger la basura, ponla dentro del camion de basura. Puedes terminar el trabajo en cualquier momento, cuando decidas que quieres terminar, solo regresa a la base y guarda el camion. El pago depende del numero de bolsas de basura que hayas recogido. Algunas bolsas de basuras pueden no estar sincronizadas con ciertos jugadores.",  
    ["partyIsFull"] = "Fallo al enviar invitación, tu grupo esta full",
    ["exploit"] = "No puedes recolectar bolsas de basura si alguien esta cerca", -- Only if Config.EnableExploitFix is true
