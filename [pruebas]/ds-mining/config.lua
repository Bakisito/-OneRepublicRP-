...
Config.Blip = {
    ...
    ['c4_blip'] = {
        ...
        Scale = 0.6,
        Color = 3,
        Label = 'Localización del mineral'
    }
}
...
Config.SellingPrices = {
    ...
    ["gold_bar"] = {label = "Barra de Oro", price = math.random(100,150)},
    ["iron_bar"] = {label = "Barra de Hierro", price = math.random(100,150)},
    ["tin_bar"] = {label = "Barra de Estaño", price = math.random(100,150)},
    ["aquamarine"] = {label = "Aquamarina", price = math.random(100,150)},
    ["greenberyl"] = {label = "Esmeralda", price = math.random(100,150)},
    ["ruby"] = {label = "Ruby", price = math.random(100,150)},
    ["coal"] = {label = "Carbon", price = math.random(100,150)},
    ["bauxite"] = {label = "Bauxita", price = math.random(100,150)},
    ["sulfur_bar"] = {label = "Azufre", price = math.random(100,150)},
    ["lead_ore"] = {label = "Mineral de plomo", price = math.random(100,150)},
...
Config.ItemProcess = {
    ['unshapped_tin'] = {label = "Estaño", reward = "tin_bar", qty = math.random(2,2), usemelt = true},
    ['unshapped_iron'] = {label = "Hierro", reward = "iron_bar", qty = math.random(1,2), usemelt = true},
    ['unshapped_gold'] = {label = "Oro", reward = "gold_bar", qty = math.random(1,2), usemelt = true},
    ['unshapped_copper'] = {label = "Cobre", reward = "copper_bar", qty = math.random(1,2), usemelt = true},
    ['aquamarine_unshapped'] = {label = "Aquamarina", reward = "aquamarine", qty = math.random(1,2), usemelt = false},
    ['greenberyl_unshapped'] = {label = "Esmeralda", reward = "greenberyl", qty = math.random(1,2), usemelt = false},
    ['ruby_unshapped'] = {label = "Ruby", reward = "ruby", qty = math.random(1,2), usemelt = false},
    ['unshapped_coal'] = {label = "Carbón", reward = "coal", qty = math.random(1,2), usemelt = false},
    ['unshapped_sulfur'] = {label = "Azufre", reward = "sulfur_bar", qty = math.random(1,2), usemelt = true},
    ['unshapped_bauxite'] = {label = "Bauxita", reward = "bauxite", qty = math.random(1,2), usemelt = true},
    ['unshapped_lead'] = {label = "Mineral de plomo", reward = "lead_ore", qty = math.random(1,2), usemelt = true},
    ['uncut_diamond'] = {label = "Diamante", reward = "ds_diamond", qty = math.random(1,2), usemelt = false},
...
Config.FoodShopItems = { -- Food Shop
    [1] = {
        name = "marlboro", -- Item name
        price = 8, -- Price per item
...
Config.Targets = {
    [1] = {coords = vector3(2922.68, 2656.51, 43.12), heading = 311.41, length = 1.5, width = 1.5, type = 'client', event = "ds-mining:washmetals", label = "Lavar Mineral"},
    [2] = {coords = vector3(2922.36, 2653.42, 43.1), heading = 271.27, length = 2.5, width = 2.5, type = 'client', event = "ds-mining:enteramount", label = "Fundir Mineral"},
    [3] = {coords = vector3(2918.85, 2647.05, 43.17), heading = 211.07, length = 1.0, width = 2.5, type = 'client', event = "ds-mining:pourmetals", label = "Vaciar Mineral Fundido"},
    [4] = {coords = vector3(2918.74, 2655.24, 43.17), heading = 44.58, length = 1.0, width = 0.8, type = 'client', event = "ds-mining:selectdiamond", label = "Dar Forma al Mineral"},
    [5] = {coords = vector3(2920.3, 2647.94, 43.15), heading = 209.08, length = 0.9, width = 0.5, type = 'client', event = "ds-mining:openfoodshop", label = "Abrir tienda"},
}
