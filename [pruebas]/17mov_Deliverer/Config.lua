...
Config.Lang = {
    ...
    ["TargetCoords"] = "Destino del repartidor",
    ["deliverParcel"] = "Entregar el paquete ;)",
    ["takeParcel"] = "Recoger el paquete",
    ["wait"] = "Espera a que alguien te abra la puerta",
    ["missingParcel"] = "No tienes el paquete contigo. Buscalo en el auto",
    ...
    ["tutorial"] = "El trabajo se basa en entregar paquetes. Si trabajas en un equipo, una persona manejara el auto hacia el lugar, mientras la otra persona saca el paquete del vehiculo, y lleva el paquete hacia la casa. Por otro lado, si trabajas solo, tienes que hacer las 2 cosas tu mismo. El pago depende del numero de paquetes entregados. Termina el trabajo cuando quieras regresando a la base y dejando el auto en el lugar designado",
    ["partyIsFull"] = "Fallo al enviar invitación, tu grupo esta full",
    ["inviteSent"] = "Invitación Enviada!",
    ["tooFar"] = "Estas muy lejos de la ubicacion del objetivo para recoger el paquete",
