...
------------------------------------------------------DISPATCH----------------------------------------------------------------
Config.PoliceNotify = {
    Chance = 70, --Number 0-100. Lower the number less chance to alert. 0 = will never alert. 100 = will always alert.
...
Config.Licenses = {
    Helicopter = {
        ...
        CheckJob = false, --IF TRUE WILL CHECK PLAYERS JOB AGAINST JOBS LISTED IN [AuthorizedJobs]. IF TRUE WILL GIVE PLAYER KEYS TO HELICOPTER WHEN THEY SIT IN THE DRIVER SEAT. WILL NOT BE USED FOR CUSTOM FRAMEWORK
...
Config.Lockpick = {
    ...
    IgnitionFailChance = 25, --NUMBER 0-100. LOWER NUMBER = LESS CHANCE TO FAIL THE ATTEMPT. 0 = NEVER FAIL. 100 = ALWAYS FAIL.
    IgnitionBreakPick = {
        OnSuccess = {
            ...
            Chance = 25 --NUMBER 0-100. LOWER NUMBER = LESS CHANCE TO BREAK LOCKPICK. 0 = NEVER BREAK. 100 = ALWAYS BREAK. ADVANCED PICK WILL BE HALF OF THIS VALUE
        },
        OnFail = {
            ...
            Chance = 35 --NUMBER 0-100. LOWER NUMBER = LESS CHANCE TO BREAK LOCKPICK. 0 = NEVER BREAK. 100 = ALWAYS BREAK. ADVANCED PICK WILL BE HALF OF THIS VALUE
        }
    },
    ...
    DoorsFailChance = 30, --NUMBER 0-100. LOWER NUMBER = LESS CHANCE TO FAIL THE ATTEMPT. 0 = NEVER FAIL. 100 = ALWAYS FAIL.
    DoorsBreakPick = {
        OnSuccess = {
        ...
        OnFail = {
            ...
            Chance = 40 --NUMBER 0-100. LOWER NUMBER = LESS CHANCE TO BREAK LOCKPICK. 0 = NEVER BREAK. 100 = ALWAYS BREAK. ADVANCED PICK WILL BE HALF OF THIS VALUE
        }
    },
...
Config.HotwireTime = { --DOES NOT APPLY IF USING MINIGAME BELOW
    ...
    Max = 45 --Maximum time to attempt a hotwire (Seconds)
}
...
Config.KeysAsItem = { --THIS FEATURE CURRENTLY ONLY SUPPORTS (QBCORE FRAMEWORK WITH QB-INVENTORY) OR (ESX-LEGACY FRAMEWORK WITH OX_INVENTORY); DO NOT ENABLE IF YOU RUN SOMETHING DIFFERENT.
    ...
    Peds = { --ADD AS MANY NPC PEDS AS YOU WOULD LIKE FOR PLAYERS TO HAVE ACCESS TO THE KEYFOB MANAGEMENT MENU. UseTarget MUST BE TRUE FOR THESE PEDS TO BE LOADED.
        { --norte
            ...
            vec3(1660.96, 4812.71, 42.08), 
            vec3(1706.97, 4815.4, 42.08),
            vec3(1696.86, 4916.02, 42.08),
            vec3(1652.53, 4933.76, 42.08)
            },
            debug = false, --TRUE = SHOWS POLYZONE SO YOU CAN TEST YOUR ZONE / FALSE = POLYZONE NOT SHOWN. 
            PedPosition = {x = 1681.66, y = 4857.68, z = 42.08, h = 198.19}, --COORDS FOR THE NPC PED. BLIP USES THESE COORDS IF ENABLED
            ...
            Blip = {
                ...
                Color = 55, --BLIP COLOR
                Label = 'Cerrajero de vehículos', --TEXT THAT SHOWS WHEN YOU CLICK ON THE BLIP IN THE GAME MAP
                ShortRange = true, --TRUE = BLIP ONLY SHOWS ON MINIMAP WHILE NEAR / FALSE = SHOWS ON MINIMAP AT ALL TIMES
            }
        },
        { --Zona Baja
            Coords = {
                vec3(134.3798, -1800.3866, 29.0),
                vec3(177.4346, -1750.7894, 29.0),
                vec3(239.0701, -1805.1200, 29.0), 
                vec3(191.3705, -1860.4001, 29.0)
            },
            debug = false,
            PedPosition = {x = 170.9208, y = -1797.9648, z = 29.0, h = 323.5371},  
            Freeze = false,
            Hash = 1142162924,
            Blip = {
                ShowBlip = true,
                ...
                Scale = 1.0,
                Color = 55,
                Label = 'Cerrajero de vehículos',
                ShortRange = true,
            }
        },
        { --zona alta
        Coords = {
            vec3(-137.58, 100.81, 72.09),
            vec3(-30.71, 45.96, 72.09),
            vec3(-37.84, 5.31, 72.09),
            vec3(-133.05, 42.4, 72.09)
        },
        debug = false,
        PedPosition = {x = -96.67, y = 43.48, z = 72.09, h = 335.24},  
        Freeze = false,
        Hash = 1142162924,
        Blip = {
            ShowBlip = true,
