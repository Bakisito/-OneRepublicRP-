...
Config.OnePercentWorth = 50            -- Means that 1% progress will reward players with $100
...
Config.Clothes = {
    ...
    male = {
        ...
        ["pants"] = {clotheId = 77, variation = 3},
        ["bag"] = {clotheId = 0, variation = 0},
        ["shoes"] = {clotheId = 205, variation = 0},
        ["t-shirt"] = {clotheId = 122, variation = 0},
        ["torso"] = {clotheId = 348, variation = 9},
        ["decals"] = {clotheId = 0, variation = 0},
        ["kevlar"] = {clotheId = 0, variation = 0},
    },

    maleHelmet = { clotheId = 126, variation = 8},
...
Config.Lang = {
    ...
    ["wrongCar"] = "Este no es el vehículo de tu empresa",
    ["CarNeeded"] = "Necesitas un vehículo de la empresa para terminar el trabajo.",
    ["nobodyNearby"] = "No hay nadie alrededor",
    ["cantInvite"] = "Para poder invitar mas personas, debes terminar el trabajo primero",
    ["inviteSent"] = "Invitación Enviada!",
    ["spawnpointOccupied"] = "El sitio para spawnear el vehículo o la mezcladora esta o",
    ["pipesNotReady"] = "Antes de hechar el concreto, tienes que instalar las tuberías",
    ["clickToPour"] = "~INPUT_CONTEXT~ para hechar el concreto",
    ["installPipe"] = "Instalar tubería",
    ["pickupBlock"] = "Recoger bloque",
    ["tutorialAfterMixerPickup"] = "Has tomado la mezcladora designada para tu jefe. Llevala al area de construcción, y despues libera el concreto en las areas designadas. El area de construcción esta seleccionada en el GPS",
    ["startingTutorial"] = "Bienvenido al trabajo de construcción. Una varidedad de tareas te espera en la zona, desde soldar, hasta construir muros, hacer drenajes, o regar concreto. Si estas trabajando en grupo, tendran que repartirse las tareas, una persona tiene que ser dejada en el punto de recogida de la mezcladora y despues transportar la mezcladora a la zona de construcción. Cada actividad sera explicada la primera vez que te acerques. Tienes las zonas donde se encuentran las tareas marcadas en el mapa. Si trabajas solo, tendras que completar cada tarea por ti mismo, si trabajas en grupo - puedes elegir como dividirlas. Tu no tienes que hacer todas las tareas, puedes terminar cuando quieras, y tu pago depende del % de las tareas que hagas. Te desamos suerte!",
    ["installBlock"] = "Construir un muro",
    ["tutorialWallBuilding"] = "Estas al lado del marco de la pared, tu tarea es construirla utilizando bloques. Los bloques estan cerca del marco, y estan marcados en el GPS. Camina hacia la pila de bloques, recoge uno, y montalo en el muro",
    ["tutorialAboutPipes"] = "Estas al lado de un agujero con vistas a las tuberías de alcantarillado. Tu tarea es instalar las tuberías en el lugar correcto. Despues de instalar las tuberías, debes liberar el concreto sobre el agujero utilizando la mezcladora. ",
    ["tutorialWelding"] = "Estas al lado del lugar donde el jefe te dijo que soldaras algo. El trabajo es simple, no requiere mas explicación",
    ["startWelding"] = "Empezar a soldar",
    ["workstationOccupied"] = "Esta estacion de trabajo esta ocupada",
    ["notFullJob"] = "Tienes que hacer 100% de progreso antes de finalizar un trabajo",
    ...
    ["cantLeaveLobby"] = "No puedes dejar el lobby mientras estas trabajando. Primero, finaliza el trabajo.",
    ...
    ["noMixerStatus"] = "Actualmente, no hay ninguna mezcladora libre para ti. Por favor intenta de nuevo mas tarde",
    ["dontHaveReqItem"] = "Tu o alguien de tu equipo no tiene los items necesarios para iniciar el trabajo",
...
Config.JobBlipsStyle = {
    ["mixerSpawnLocation"] = {
        color = 47,
        string = "~o~[BUILDER]~s~ Mezcladora para recoger",
        sprite = 800,
    },
    ["mixerTargetLocation"] = {
        color = 47,
        string = "~o~[BUILDER]~s~ lugar de entregar de la mezcladora",
        sprite = 652,
    },
    ["installPipe"] = {
        color = 47,
        string = "[BUILDER] Instalar tubería",
        sprite = nil,
    },
    ["blockPickup"] = {
        color = 47,
        string = "~o~[BUILDER]~s~ Recoger bloques para la Construcción del muro",
        sprite = 655, 
    },
    ["buildWall"] = {
        color = 47,
        string = "~o~[BUILDER]~s~ Construir un muro",
        sprite = 285, 
    },

    ["welding"] = {
        color = 47,
        string = "~o~[BUILDER]~s~ Soldando",
        sprite = 468, 
    },
}
