...
Config.IBANPrefix = "OR" -- IBAN prefix
...
Config.CreditCardItem = "visa" -- Required item to access the ATM
...
Config.BotName = 'Banking Logs' -- Write the desired bot name

Config.ServerName = 'One Republic RP' -- Write your server's name

Config.IconURL = 'https://cdn.discordapp.com/attachments/1037776105408573450/1068003393676771348/one-republic-logo-3.png' -- Insert your desired image link
