...
QBCore.Functions.CreateUseableItem("toolboxa", function(source, item) TriggerClientEvent('jim-mechanic:client:Menu', source) end)
QBCore.Functions.CreateUseableItem("mechanic_toolsa", function(source, item) TriggerClientEvent('jim-mechanic:client:Repair:Check', source) end)
