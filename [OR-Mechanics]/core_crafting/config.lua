...
['turbo_lvl_1'] = {
	...
	isGun = false, -- Specify if this is a gun so it will be added to the loadout
	Jobs = 'mechanic, mechanic2, biembo, mechanic4, mechanic5, mechanic6, mechanic7', -- What jobs can craft this item, leaving {} allows any job
	JobGrades = {}, -- What job grades can craft this item, leaving {} allows any grade
	Amount = 1, -- The amount that will be crafted
	SuccessRate = 90, -- 90% That the craft will succeed! If it does not you will lose your ingredients
	requireBlueprint = false, -- Requires a blueprint whitch you need to add in the database yourself TEMPLATE: itemname_blueprint EXAMPLE: bandage_blueprint
...
['stock_engine'] = {
	...
	isGun = false, -- Specify if this is a gun so it will be added to the loadout
	Jobs = 'mechanic1, mechanic2, biembo, mechanic4, mechanic5, mechanic6, mechanic7', -- What jobs can craft this item, leaving {} allows any job
	JobGrades = {}, -- What job grades can craft this item, leaving {} allows any grade
	Amount = 1, -- The amount that will be crafted
	SuccessRate = 90, -- 90% That the craft will succeed! If it does not you will lose your ingredients
	requireBlueprint = false, -- Requires a blueprint whitch you need to add in the database yourself TEMPLATE: itemname_blueprint EXAMPLE: bandage_blueprint
...
['m5cracklemod'] = {
	...
	Category = 'engines',
	isGun = false, 
	Jobs = 'mechanic1, mechanic2, biembo, mechanic4, mechanic5, mechanic6, mechanic7',  
	JobGrades = {}, -- What job grades can craft this item, leaving {} allows any grade
	Amount = 1, 
	SuccessRate = 90, 
...
-- Coke
['coke_small_brick'] = {
	ItemName = 'Brick de 50',
	Level = 0, -- From what level this item will be craftable
	Category = 'coke', -- The category item will be put in
	isGun = false, -- Specify if this is a gun so it will be added to the loadout
	Jobs = {}, -- What jobs can craft this item, leaving {} allows any job
	JobGrades = {}, -- What job grades can craft this item, leaving {} allows any grade
	Amount = 1, -- The amount that will be crafted
...
['big_coke_brick'] = {
	...
	JobGrades = {}, -- What job grades can craft this item, leaving {} allows any grade
	Amount = 1, -- The amount that will be crafted
	SuccessRate = 85, -- 90% That the craft will succeed! If it does not you will lose your ingredients
	requireBlueprint = false, -- Requires a blueprint whitch you need to add in the database yourself TEMPLATE: itemname_blueprint EXAMPLE: bandage_blueprint
...
Workbenches = { -- Every workbench location, leave {} for jobs if you want everybody to access
		...
		{coords = vector3(543.04, -185.68, 55.20), jobs = 'biembo', Categories = 'MechCategories', blip = false, recipes = {}, radius = 3.0 },         
		...
		{coords = vector3(590.58, -415.01, 18.5), jobs = {}, Categories = 'CokeCategories', blip = false, recipes = {}, radius = 3.0 },         
