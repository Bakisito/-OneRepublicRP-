...
Config = {
    ...
    DiscordMessageDescription = "¡Se han activado las sirenas antiaéreas!",
    DiscordMessageText = "El gobierno les aconseja permanecer en casa y estar atentos a cualquier novedad. Se les informará lo antes posible de la emergencia en curso!",
    DiscordFooterText = "OneRepublic Software © ",
    ...
    Messages = {
        ...
        JustActivated = "🗙 ARS en enfriamiento, espera 2,5 segundos",
        IgnoreSirensCommandHelpText = "Activa o desactiva los sonidos de las sirenas antiaéreas",
        OpenARSMenuHelpText = "Abre el panel de control de las sirenas antiaéreas",
        DrawCoverageHelpText = 'Dibuja marcadores sobre el suelo para reproducir el alcance del sonido de las Sirenas Antiaéreas',
        NoPermission = "No tienes los permisos necesarios",
        ToggledSirensOn = "Has activado el sonido de las sirenas antiaéreas ~g~on~w~",
        ToggledSirensOff = "Has activado el sonido de las sirenas antiaéreas ~r~off~w~.",
        ToggledDrawCoverageOn = "Has activado la cobertura de dibujo ~g~on~w~.",
        ToggledDrawCoverageOff = "Has activado la cobertura de dibujo ~r~off~w~.",
    },
}
