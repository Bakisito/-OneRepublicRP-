...
Config.Languages = {
    ['en'] = {
        ['speak'] = 'Para hablar con megáfono pulse '..Config.Keys.SpeakKeyString,
        ['speakcar'] = 'Para hablar con megáfono pulse '..Config.Keys.SpeakCarKeyString,
        ['managevolume'] = 'Volumen: ~r~{s}%',
    },
    ['fr'] = {
