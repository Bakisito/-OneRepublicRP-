...
if (!animating) {
  ...
  $("#main_container").html("");
    ...
    html_header += "<div id=\"header_title\">" + 'INFORME POLICIAL' + "</div>";
    html_header += "<div id=\"header_seal\"></div>";
    html_header += "<div id=\"header_details\"><h2>" + 'Informe oficial del equipo forense de la policía por las evidencias aportadas!' + "</h2>";
    ...
    for (i = 0; i < Object.keys(evidence).length; i++) {
        ...
        html_middle += "<div id=\"section_footer_block\">" + 'EVIDENCIA #' + (i + 1) + ' (' + evidence[i]["type"] + ')' + "</div>";
