...
Config = {
    ...
    RechargeCoords = { -- Coordinated to recharge the pepper spray and decontamination spray
        vector3(462.77, -998.19, 31.74),
        vector3(473.07, -968.26, 23.94),
    },
    RechargeRadius = 1.5, -- Distance to recharge
...
Config.Languages = {
    ['en'] = {
        ['quantity'] = 'Tienes ~b~{s}ml',
        ['split'] = 'Escupir presiona '..Config.Keys.SplitKeyString,
        ['rubbing'] = 'Frotarse los ojos presiona '..Config.Keys.RubbingKeyString,
        ['replacepepperspray'] = 'Reemplace su spray de pimienta presiona '..Config.Keys.ReplaceKeyString,
        ['replacedecontamination'] = 'Reemplace su spray descontaminante presiona '..Config.Keys.ReplaceKeyString
    },
    ['fr'] = {
