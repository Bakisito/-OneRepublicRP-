...
Config = {
	...
	Products = {
		["autoparts"] = {
			{ name = "engine_cylinder", price = 3500, amount = 50, },
			{ name = "piston", price = 1600, amount = 50, },
			{ name = "engine_crankshaft", price = 2400, amount = 50, },
			{ name = "engine_oilpan", price = 1500, amount = 50, },
			{ name = "engine_block", price = 7500, amount = 50, },
			{ name = "engine_belts", price = 500, amount = 50, },
			{ name = "car_frame", price = 50, amount = 50, },
			{ name = "doorhandle", price = 50, amount = 50, },
		    { name = "rearview", price = 50, amount = 50, },
			{ name = "hood_frame", price = 50, amount = 50, },
			{ name = "hood_vent", price = 50, amount = 50, },
		 	{ name = "hood_sheet", price = 50, amount = 50, },
			{ name = "trunk_frame", price = 75, amount = 50, },
			{ name = "trunk_sheet", price = 75, amount = 50, },
			{ name = "turbine", price = 2200, amount = 50, },
			{ name = "turbo_parts", price = 500, amount = 50, },
			{ name = "transmission", price = 2000, amount = 50, },
			{ name = "gears", price = 400, amount = 50, },
			{ name = "transmission_shaft", price = 4000, amount = 50, },
			{ name = "suspension_body", price = 6000, amount = 50, },
			{ name = "suspension_spring", price = 6000, amount = 50, },
			{ name = "oilcan", price = 600, amount = 50, },
			{ name = "brake_capiler", price = 4000, amount = 50, },
			{ name = "brake_pad", price = 4000, amount = 50, },
			{ name = "brake_disc", price = 4000, amount = 50, },
			{ name = "wheel_rim", price = 4000, amount = 50, },
			{ name = "wheel_rubber", price = 2000, amount = 50, },
		...
		["weapons"] = {
			...
			{ name = "weapon_fnx45", price = 250, amount = 20,  },
			{ name = "weapon_m9", price = 250, amount = 20,  },
			{ name = "weapon_m1911", price = 250, amount = 20,  },
...
Config.Locations = {
	...
	["autoadorno"] = {
		...
		["type"] = "items",
		["job"] = "mechanic1","mechanic2","mechanic3","mechanic4","mechanic5","mechanic6",
		["model"] = {
		`mp_f_bennymech_01`,
		`s_m_y_xmech_01`,
		`s_m_y_xmech_02`,
