...
function FormatItemInfo(itemData) {
    if (itemData != null && itemData.info != "") {
        ...
        if (itemData.name == "id_card") {
            ...
            itemData.info.MotelName + '</span></p><p><strong>Room No: </strong><span>' + 
            itemData.info.UnRealMotelRoom + '</span></p><p><strong>Password: </strong><span>' + 
            itemData.info.Password + '</span></p>'
            );
