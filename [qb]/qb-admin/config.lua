...
Config.ServerDiscord                        = "discord.gg/yjCmVvC5tE" -- For kick/ban messages
Config.ScreenshotWebhook                    = "https://discord.com/api/webhooks/963569950289698917/2q0yiyp9VqFuKtAxU0qvId0IKBxJhooXTjeF-cZFR8MGVPHqv4cKrx6Eu2ROuNC7QxNH"
Config.LogsWebhook                          = "https://discord.com/api/webhooks/963569950289698917/2q0yiyp9VqFuKtAxU0qvId0IKBxJhooXTjeF-cZFR8MGVPHqv4cKrx6Eu2ROuNC7QxNH"
...
function DebugTrace(message)
    if Config.EnableDebug then
        print("^3[OR-ADMIN Admin ("..GetCurrentResourceName()..")]^7 "..message)
    end
end
