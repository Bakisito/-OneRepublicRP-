...
AdminPanel.ShowAlert = function(type, alertText) {
    ...
    Toast.create("OR ADMIN", alertText, type, 3000);
}
...
AdminPanel.Open = function(data) {
    ...
    $('.copyright').html('<span>One Republic Admin<span id="919adminversion"></span><br />Copyright &copy; 2021-2023 OR-Devs <img src="assets/img/rd.png" class="mb-1" /></span>');
    $("#919adminversion").html(AdminPanel.Version);
