...
RegisterKeyMapping("*adminpanel", "(OR-ADMIN)", "keyboard", Config.AdminPanelKey)

RegisterCommand("*noclip", function()
    TriggerServerEvent("919-admin:server:RequestNoClip")
end, false)
RegisterKeyMapping("*noclip", Lang:t("commands.noclip").."(OR-ADMIN)", "keyboard", Config.NoClipKey)
...
RegisterKeyMapping("*showNames", Lang:t("commands.showNames").."(OR-ADMIN)", "keyboard", Config.ShowNamesKey)
