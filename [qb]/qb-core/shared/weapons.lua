...
QBShared.Weapons = {
	...
	[`weapon_hammer`] 				 = {['name'] = 'weapon_hammer', 		['label'] = 'Martillo', 			['weapontype'] = 'Melee',	['ammotype'] = nil,	['damagereason'] = 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered'},
...
--	[`weapon_smg_mk2`] 				 = {['name'] = 'weapon_smg_mk2', 		['label'] = 'SMG MK2', 			    ['weapontype'] = 'Submachine Gun',	['ammotype'] = 'AMMO_SMG',		['damagereason'] = 'Riddled / Drilled / Finished / Submachine Gunned'},
	[`weapon_assaultsmg`] 			 = {['name'] = 'weapon_assaultsmg', 	['label'] = 'FN P90', 				['weapontype'] = 'Submachine Gun',	['ammotype'] = 'AMMO_SMG',		['damagereason'] = 'Riddled / Drilled / Finished / Submachine Gunned'},
	...
	-- [`weapon_assaultrifle_mk2`] 	 = {['name'] = 'weapon_assaultrifle_mk2', 	['label'] = 'Assault Rifle MK2', 			['weapontype'] = 'Assault Rifle',	['ammotype'] = 'AMMO_RIFLE',	['damagereason'] = 'Ended / Rifled / Shot down / Floored'},
	 [`weapon_carbinerifle`] 		 = {['name'] = 'weapon_carbinerifle', 	 	['label'] = 'SIG MCX', 						['weapontype'] = 'Assault Rifle',	['ammotype'] = 'AMMO_RIFLE',	['damagereason'] = 'Ended / Rifled / Shot down / Floored'},
  ...
  --  [`weapon_emplauncher`] 			 = {['name'] = 'weapon_emplauncher', 			['label'] = 'EMP Launcher', 			['weapontype'] = 'Heavy Weapons',	['ammotype'] = 'AMMO_EMPLAUNCHER',		['damagereason'] = 'Died'},
    ...
    -- Throwables
	[`weapon_smok2grenade`] 		        = {['name'] = 'weapon_smok2grenade', 		['label'] = 'H&L TG-69 Smoke Grenade', 			['weapontype'] = 'Throwable',	['ammotype'] = nil,				['damagereason'] = 'Died'},
	[`weapon_flashbang`] 		        = {['name'] = 'weapon_flashbang', 		['label'] = 'M84 Stun Grenade', 			['weapontype'] = 'Throwable',	['ammotype'] = nil,				['damagereason'] = 'Died'},

	[`weapon_grenade`] 		        = {['name'] = 'weapon_grenade', 		['label'] = 'Granada MK II', 			['weapontype'] = 'Throwable',	['ammotype'] = nil,				['damagereason'] = 'Bombed / Exploded / Detonated / Blew up'},
...
--	[`weapon_pipebomb`] 	        = {['name'] = 'weapon_pipebomb', 		['label'] = 'Pipe Bomb', 		['weapontype'] = 'Throwable',	['ammotype'] = nil,				['damagereason'] = 'Bombed / Exploded / Detonated / Blew up'},
	...
	[`weapon_m4`] 					 = {['name'] = 'weapon_m4', 	 		['label'] = 'M4A1 Carbine', 				['ammotype'] = 'AMMO_RIFLE',	['damagereason'] = 'Ended / Rifled / Shot down / Floored'},
	...
	[`weapon_mp9`] 			 		 = {['name'] = 'weapon_mp9', 			['label'] = 'Brügger & Thomet MP9', ['ammotype'] = 'AMMO_SMG',		['damagereason'] = 'Riddled / Drilled / Finished / Submachine Gunned'},
	[`weapon_mp5`] 			 		 = {['name'] = 'weapon_mp5', 			['label'] = 'Heckler & Koch MP5', ['ammotype'] = 'AMMO_SMG',		['damagereason'] = 'Riddled / Drilled / Finished / Submachine Gunned'},

	[`weapon_m110`] 		 		 = {['name'] = 'weapon_m110', 	 		['label'] = 'M110 Semi-Automatic', 	['ammotype'] = 'AMMO_SNIPER',	['damagereason'] = 'Ended / Sniped / Shot down / Floored'},
	[`weapon_hk416`] 		 		 = {['name'] = 'weapon_hk416', 	 		['label'] = 'HK-416', 				['ammotype'] = 'AMMO_RIFLE',	['damagereason'] = 'Ended / Rifled / Shot down / Floored'},

	[`weapon_fbiarb`] 		 		 = {['name'] = 'weapon_fbiarb', 	 	['label'] = 'AR-15', 				['ammotype'] = 'AMMO_RIFLE',	['damagereason'] = 'Ended / Rifled / Shot down / Floored'},
	[`weapon_mk18b`] 		 		 = {['name'] = 'weapon_mk18b', 	 		['label'] = 'SOCOM-MK18', 			['ammotype'] = 'AMMO_RIFLE',	['damagereason'] = 'Ended / Rifled / Shot down / Floored'},

	[`weapon_pp19`] 			 	 = {['name'] = 'weapon_pp19', 			['weapontype'] = 'Submachine Gun',		['label'] = 'PP-19 Vitaz', 			['weapontype'] = 'Submachine Gun',	['damagereason'] = 'Riddled / Drilled / Finished / Submachine Gunned'},

	[`weapon_g17`] 				 	 = {['name'] = 'weapon_g17', 		['label'] = 'Glock 17C', 			['ammotype'] = 'AMMO_PISTOL',	['damagereason'] = 'Pistoled / Blasted / Plugged / Bust a cap in'},
	[`weapon_m45a1`] 				 = {['name'] = 'weapon_m45a1', 		['label'] = 'Colt M45A1', 			['ammotype'] = 'AMMO_PISTOL',	['damagereason'] = 'Pistoled / Blasted / Plugged / Bust a cap in'},

	[`weapon_nsr9`] 		 		 = {['name'] = 'weapon_nsr9', 	 		['label'] = 'Noveske NSR 9', 			['ammotype'] = 'AMMO_RIFLE',	['damagereason'] = 'Ended / Rifled / Shot down / Floored'},
	[`weapon_miniuzi`] 					 = {['name'] = 'weapon_miniuzi', 			['label'] = 'UZI', 					['ammotype'] = 'AMMO_SMG',		['damagereason'] = 'Riddled / Drilled / Finished / Submachine Gunned'},
	[`weapon_mk18`] 		 		 = {['name'] = 'weapon_mk18', 	 		['label'] = 'SOCOM-MK18C', 			['ammotype'] = 'AMMO_RIFLE',	['damagereason'] = 'Ended / Rifled / Shot down / Floored'},

	[`weapon_mpx`] 		 		 	 = {['name'] = 'weapon_mpx', 	 		['label'] = 'SIG Sauer MPX', 			['ammotype'] = 'AMMO_RIFLE',	['damagereason'] = 'Ended / Rifled / Shot down / Floored'},

    [`weapon_megaphone`]             = {['name'] = 'weapon_megaphone',	['label'] = 'Megáfono',	 ['ammotype'] = nil,	['damagereason'] = 'Died'},
    [`weapon_pepperspray`]             = {['name'] = 'weapon_pepperspray',	['label'] = 'Pepper Spray',	 ['ammotype'] = nil,	['damagereason'] = 'Died'},
    [`weapon_antidote`]             = {['name'] = 'weapon_antidote',	['label'] = 'Cool-It Spray descontaminante',	 ['ammotype'] = nil,	['damagereason'] = 'Died'},
	[`weapon_prolaser4`] 			= {['name'] = 'weapon_prolaser4',  	['label'] = 'Lidar Gun',		['ammotype'] = 'nil',		['damagereason'] = 'Ticketed / Fined / Caught Speeding / Slow Down'	},
