...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 500, bank = 7500, crypto = 0, blackmoney = 0 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
QBConfig.Money.DontAllowMinus = { 'cash', 'crypto','blackmoney' } -- Money that is not allowed going in minus
QBConfig.Money.PayCheckTimeOut = 35 -- The time in minutes that it will give the paycheck
...
QBConfig.Server.ClosedReason = "Servidor en mantenimiento" -- Reason message to display when people can't join the server
...
QBConfig.Server.Discord = "https://discord.gg/yjCmVvC5tE" -- Discord invite link
