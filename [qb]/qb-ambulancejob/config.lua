...
Config.Helicopter = "emsair" -- Helicopter model that players with the ambulance job can use
...
Config.MessageTimer = 60 -- How long it will take to display limb/bleed message
...
Config.BlackoutTimer = 4 -- How many bleed ticks occur before blacking out
...
Config.MajorArmoredBleedChance = 35 -- The chance, in percent, that a player will get a bleed effect when taking heavy damage while wearing armor
...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ["checking"] = {
	    --   [1] = vector3(312.06, -593.46, 43.28),
       -- [2] = vector3(350.06, -588.28, 28.81),
	   -- [3] = vector3(-254.54, 6331.78, 32.43), -- paleto
    },
    ["duty"] = {
        [1] = vector3(306.45, -597.53, 43.28),
    ...
    ["armory"] = {
        [1] = vector3(0.93, -0.94, 0.29),
    },
    ["roof"] = {
       -- [1] = vector4(338.5, -583.85, 74.16, 245.5),
    },
    ["main"] = {
       -- [1] = vector3(332.43, -595.61, 43.28),
    },
    ["stash"] = {
        [1] = vector3(306.59, -601.75, 43.28),
    },
    ["beds"] = {
        [1] = {coords = vector4(324.26, -582.77, 43.2, 158.15), taken = false, model = 1631638868},
        [2] = {coords = vector4(322.59, -587.32, 43.2, 336.72), taken = false, model = 1631638868},
        [3] = {coords = vector4(319.33, -581.15, 43.2, 168.61), taken = false, model = 1631638868},
        [4] = {coords = vector4(317.67, -585.24, 43.2, 338.29), taken = false, model = 1631638868},
        [5] = {coords = vector4(314.47, -584.23, 43.2, 339.52), taken = false, model = 1631638868}, 
        [6] = {coords = vector4(313.81, -579.04, 43.2, 156.64), taken = false, model = 1631638868}, 
        [7] = {coords = vector4(311.12, -582.9, 43.2, 338.82), taken = false, model = 1631638868}, 
        [8] = {coords = vector4(309.33, -577.3, 43.2, 158.98), taken = false, model = 1631638868},
        [9] = {coords = vector4(307.63, -581.9, 43.2, 336.67), taken = false, model = 1631638868},
	--- paleto
...
Config.StaggerAreas = { -- Define body areas that will always cause staggering if wearing armor or not
   ...
   -- ['UPPER_BODY'] = { armored = false, major = 60, minor = 30 },
    -- ['LLEG'] = { armored = true, major = 65, minor = 30 },
    -- ['RLEG'] = { armored = true, major = 65, minor = 30 },
    -- ['LFOOT'] = { armored = true, major = 65, minor = 30 },
    -- ['RFOOT'] = { armored = true, major = 65, minor = 30 },
}
...
Config.Weapons = { -- Correspond weapon names to their class number
   ...
   [`WEAPON_FBIARB`] = Config.WeaponClasses['HIGH_CALIBER'],
   [`WEAPON_MK18B`] = Config.WeaponClasses['HIGH_CALIBER'],
   [`WEAPON_NSR9`] = Config.WeaponClasses['HIGH_CALIBER'],
   [`WEAPON_MK18`] = Config.WeaponClasses['HIGH_CALIBER'],
   [`WEAPON_MPX`] = Config.WeaponClasses['HIGH_CALIBER'],
